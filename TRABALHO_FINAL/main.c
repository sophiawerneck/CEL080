...
void vTaskDisplay(void* pvparameters)
{
    ...
    while(1)
    {
        ...
        if(bits == (EV_TEMP | EV_UMID | EV_LUM)) 
        {
            ...
            mqtt_publish("CEL080B/Sensores/BancadaH/Temperatura", msgTemp);
            mqtt_publish("CEL080B/Sensores/BancadaH/Umidade", msgUmid);
            mqtt_publish("CEL080B/Sensores/BancadaH/Luminosidade", msgLum);
